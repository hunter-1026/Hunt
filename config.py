...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002435015040"))
...
try:
    ADMINS=[6376328008]
    for x in (os.environ.get("ADMINS", "5849725855 6437082833 5777053515 7378365553 6841494969 5350104697").split()):
        ADMINS.append(int(x))
except ValueError:
