...
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Toonpro12:animebash@cluster0.e6hpn8l.mongodb.net/?retryWrites =true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "hunt")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002119590075"))
...
try:
    ADMINS=[6376328008]
    for x in (os.environ.get("ADMINS", "5849725855 6841494969 7432908941 5129642982 6437082833 5777053515 7378365553 5350104697").split()):
        ADMINS.append(int(x))
except ValueError:
